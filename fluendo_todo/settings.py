"""
Django settings for fluendo_todo project.
...
SECRET_KEY = 'django-insecure-!m^3&)%%ljkf!#$f2)!x%_q&msb)25*v_qpa9^q&5%he!$=jd2'
...
ROOT_URLCONF = 'fluendo_todo.urls'
...
WSGI_APPLICATION = 'fluendo_todo.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PORT': environ.get('DJANGO_DB_PORT', None),
        }
}
